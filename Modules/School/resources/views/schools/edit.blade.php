            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="npsn" value="{{ old('npsn', $school->npsn) }}" maxlength="8" required
                    ...
                    <div>
                        ...
                        <div class="flex gap-4 mt-2">
                            <label class="inline-flex items-center">
                                <input type="checkbox" name="kurikulum[]" value="2013"
                                    {{ in_array('2013', old('kurikulum', $school->kurikulum ?? [])) ? 'checked' : '' }} class="rounded">
                                <span class="ml-2">K13</span>
                            </label>
                            <label class="inline-flex items-center">
                                <input type="checkbox" name="kurikulum[]" value="merdeka"
                                    {{ in_array('merdeka', old('kurikulum', $school->kurikulum ?? [])) ? 'checked' : '' }} class="rounded">
            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-3 gap-4">
                    <div class="col-span-3">
                        ...
                        <input type="text" name="alamat_jalan" value="{{ old('alamat_jalan', $school->alamat_jalan) }}" required
                            class="w-full px-3 py-2 border rounded focus:ring-2 focus:ring-blue-500">
                    </div>

                    <div>
                        <label class="block text-sm font-medium mb-1">RT <span class="text-red-500">*</span></label>
                        <input type="text" name="rt" value="{{ old('rt', $school->rt) }}" maxlength="3" required
                            class="w-full px-3 py-2 border rounded focus:ring-2 focus:ring-blue-500">
                    </div>

                    <div>
                        <label class="block text-sm font-medium mb-1">RW <span class="text-red-500">*</span></label>
                        <input type="text" name="rw" value="{{ old('rw', $school->rw) }}" maxlength="3" required
                            class="w-full px-3 py-2 border rounded focus:ring-2 focus:ring-blue-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="desa_kelurahan" value="{{ old('desa_kelurahan', $school->desa_kelurahan) }}" required
                            class="w-full px-3 py-2 border rounded focus:ring-2 focus:ring-blue-500">
                    </div>

                    <div>
                        <label class="block text-sm font-medium mb-1">Kecamatan <span class="text-red-500">*</span></label>
                        <input type="text" name="kecamatan" value="{{ old('kecamatan', $school->kecamatan) }}" required
                            class="w-full px-3 py-2 border rounded focus:ring-2 focus:ring-blue-500">
                    </div>

                    <div>
                        <label class="block text-sm font-medium mb-1">Kab/Kota <span class="text-red-500">*</span></label>
                        <input type="text" name="kab_kota" value="{{ old('kab_kota', $school->kab_kota) }}" required
                            class="w-full px-3 py-2 border rounded focus:ring-2 focus:ring-blue-500">
                    </div>

                    <div>
                        <label class="block text-sm font-medium mb-1">Provinsi <span class="text-red-500">*</span></label>
                        <input type="text" name="provinsi" value="{{ old('provinsi', $school->provinsi) }}" required
                            class="w-full px-3 py-2 border rounded focus:ring-2 focus:ring-blue-500">
                    </div>

                    <div>
                        <label class="block text-sm font-medium mb-1">Kode Pos <span class="text-red-500">*</span></label>
                        <input type="text" name="kode_pos" value="{{ old('kode_pos', $school->kode_pos) }}" maxlength="5" required
                            class="w-full px-3 py-2 border rounded focus:ring-2 focus:ring-blue-500">
                    </div>
            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_kepsek" value="{{ old('nama_kepsek', $school->nama_kepsek) }}" required
                            class="w-full px-3 py-2 border rounded focus:ring-2 focus:ring-blue-500">
                    </div>

                    <div>
                        <label class="block text-sm font-medium mb-1">NIP Kepala Sekolah</label>
                        <input type="text" name="nip_kepsek" value="{{ old('nip_kepsek', $school->nip_kepsek) }}" maxlength="18"
                            class="w-full px-3 py-2 border rounded focus:ring-2 focus:ring-blue-500"
